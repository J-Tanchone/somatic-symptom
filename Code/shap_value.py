...
print("\n" + "="*80)
print("🔬 SHAP ANALYSIS - BEST MODEL FEATURE IMPORTANCE (ORIGINAL PREDICTORS)")
...
print(f"📁 SHAP plots will be saved to: {shap_dir.absolute()}")
...
for symptom_idx, (physSx_var, data_splits) in enumerate(train_test_data.items(), 1):
    ...
    try:
        ...
        if importance_info is not None:
            ...
            print(f"\n  ✅ Top 15 Predictors for {symptom_name}:")
...
try:
    ...
    if summary_data:
        ...
        print(f"  ✓ Saved: shap_top15_predictors_per_symptom_ROC_AUC.csv")
        ...
        print(f"  ✓ Saved: shap_overall_predictor_importance_ROC_AUC.csv")

        print("\n📊 Top 15 Most Important Predictors Across All Symptoms:")
        print("-" * 80)
...
print("\n" + "="*80)
print("✅ SHAP ANALYSIS COMPLETE (PREDICTOR LEVEL - ROC_AUC SELECTION)!")
print("="*80)
print(f"\n📁 SHAP plots saved in: {shap_dir.absolute()}/")
print(f"✓ Analyzed {len(symptom_shap_results)} symptoms successfully")

# ============================================================================
# SAVE RESULTS TO GOOGLE DRIVE
# ============================================================================
print("\n" + "="*80)
print("📤 SAVING SHAP RESULTS TO GOOGLE DRIVE")
print("="*80)
...
try:
    ...
    for plot_file in shap_dir.glob("*.png"):
        ...
        plot_count += 1
    print(f"  ✓ Copied {plot_count} SHAP plots")
    ...
    print(f"  ✓ Saved: analysis_metadata.json")

    print("\n✅ All SHAP results successfully saved to Google Drive!")
...
print("="*80)
print(f"\n📁 Local results: {shap_dir.absolute()}")
if 'gdrive_shap_results' in locals():
    print(f"☁️  Google Drive: {gdrive_shap_results}")